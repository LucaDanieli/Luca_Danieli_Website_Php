...
$silenzi_description = "
<p id='description_music_standard_page'><i>Silenzi</i> (<i>Silence</i>) is a musical piece for singer, recital and electronics inspired by the poem of the same name written by Marco Bragolusi.</p>
<p id='description_music_standard_page'>It was premiered at the Sonic Art Forum - experimental music and sound art conference - in Colchester (UK)  on 2-3 November 2013.</p>
";
$silenzi_add = "
...
$dramma4_description = "
<p id='description_music_standard_page'><i>Dramma in 4 parti</i> was originally conceived as a live-videoart installation: the music herein is for real-time performance. <br></p>
<p id='description_music_standard_page'>This work is a study on phonetic superimpositions as material for musical writing: syllables overlap continuously, creating hints for structure's expansions and contractions. </p>
";
$dramma4_add = "
...
<p id='description_music_standard_page'> As this work was a personal study, I can say that the piece is stylistically lively and it approaches several harmonic techniques, moving from eighteenth century ones to the contemporary. </p>
";
$studio2_add = "
...
I wrote the theatrical work <i>Agatodemone e il Cacodemone</i> when I was 21. Originally, it was conceived in three acts. The third one should be a twenty-minutes musical piece for Flute, Oboe, Tuba, Cello and Live-Electronics. Unfortunately, I never had the time to conclude this work and therefore I leave it uncomplete. Maybe I will end it someday.<br>
...
$agatodemone_image = ' <img style="position: absolute; height: 90%; top: 5%; left: 38%;" src="' . $root_page . 'Images/agatodemone_e_il_cacodemone.jpg "> ';
...
$websites_menu_top = 34;
$websites_menu_left = 10;
...
I tried then to simulate herein part of Ruby's dynamic approach to web development, by use of Content Management Systems, fragmenting the code in numerous little and re-usable scripts, which help debugging and the manteinance of the website.
</p>
";
...
<table id="websites_image" style="top: 70% height: 30%">
  ...
  <tr><td id="websites_image_section"> 
    <img style="position: absolute; height: 90%; top: 5%; left: 32%;" src="' . $root_page . 'Images/luca_danieli_website_preview.png "> 
  </td></tr>
</table>  
';
...
<table id="websites_image" style="top: 70% height: 30%">
  <tr><td style="width: 100%; height: 1px; background-color: #ef5423;"></td></tr>
  <tr><td id="websites_image_section"> 
    <img style="position: absolute; height: 90%; top: 5%; left: 28%;" src="' . $root_page . 'Images/FUSDI_preview.jpg "> 
  </td></tr>
</table>  
';
...
<table id="websites_image" style="top: 70% height: 30%">
  <tr><td style="width: 100%; height: 1px; background-color: #ef5423;"></td></tr>
  <tr><td id="websites_image_section"> 
    <img style="position: absolute; height: 90%; top: 5%; left: 30%;" src="' . $root_page . 'Images/RPSO_preview.jpg "> 
  </td></tr>
</table>  
';
